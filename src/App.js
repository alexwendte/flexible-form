...
export const Form = ({ flexPropsHelper }) => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      <Input flexProps={flexPropsHelper(0)} />
      <Input flexProps={flexPropsHelper(1)} />
      <Input flexProps={flexPropsHelper(2)} />
      <Input flexProps={flexPropsHelper(3)} />
    </div>
  )
}
